# parse_hw.py by Javier Briseno (javierbriseno@csus.edu) For CSC 135 Fall 2022
# Further testing was done in external file to make sure it worked
# Used a bit of luck and also notes from class
