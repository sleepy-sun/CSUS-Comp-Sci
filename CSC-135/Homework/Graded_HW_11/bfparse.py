# bfparse.py by Javier Briseno (javierbriseno@csus.edu) for CSC 135 Fall 2022
# Parses a bf program
# Used some luck and also helpful notes taken from https://krovetz.net/135/w11/tree.html
