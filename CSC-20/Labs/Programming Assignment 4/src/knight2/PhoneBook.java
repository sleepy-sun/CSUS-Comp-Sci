...
public class PhoneBook {
	 ...
	 */
	    public String toString(){
	       String ToString = "FirstName \t LastName \t HomeNumber \t OfficeNumber \t EmailAddress\n";
	       for(Contact i : contacts){
	            ToString+=i.getFirstName() +"\t" +i.getLastName()+"\t"+i.getHomeNumber()+"\t"+i.getOfficeNumber()+"\t"+i.getEmailAddress()+"\n";
	        }
	       return ToString;
	    }
	/**
